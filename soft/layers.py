...
class FC(Module):
    def __init__(self, fc_type= 'M V-AM',    margin=0.35, t=0.2, scale=32, embedding_size=512, num_ class=40960,
                 easy_margin=True):
        ...
        self.margin_formula = [
            lambda x: x ** 0,
            lambda x: x ** 1,
            lambda x: 2 * x ** 80 - 40,// malware CTPH  size
            lambda x: 4 * x ** 40 - 20 * x,
            lambda x: 8 * x ** 80 - 20 * x ,
